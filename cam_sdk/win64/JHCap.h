...
struct ISPParam
{
	...
	ISPParam()
	{
		ccm[0] = 1; ccm[1] = 0; ccm[2] = 0;
		ccm[3] = 0; ccm[4] = 1; ccm[5] = 0;
		ccm[6] = 0; ccm[7] = 0; ccm[8] = 1;
		gamma=1.0;
		saturation=1.0;
		contrast=1.0;
        red_gain=1.0;
...
Parameters: device_id, the index of camera to query
            *ver, contains version information, ex 4505 for version 45.5
Return: returns API_OK on success, otherwise returns API_ERROR.
Note:
 --------------------------------------------------------------*/

extern "C" DLL_EXPORT API_STATUS __stdcall CameraGetFirmVersion(int device_id,int *ver);
...
extern "C" DLL_EXPORT API_STATUS __stdcall CameraGetName(int device_id, char *name, char *model);
...
extern "C" DLL_EXPORT API_STATUS __stdcall CameraGetID(int device_id,int *modeID, int *productID);
...
Parameters: device_id, the index of camera to initialize
Return: returns API_OK on success, otherwise returns API_ERROR.
...
/*==============================================================
Name: CameraInitVirtual
Description: Initialize virtual camera context for ISP
Parameters: device_id, the index of camera context, any value between 0 to 255
            pid, the product id of the camera(CameraGetID can retrieve the product ID)
                 ex. 0x0030 for JHSM36, 0x3650 for JHUM504
            *param, isp parameters
Return: returns API_OK on success, otherwise returns API_ERROR.
Note: call CameraFree to release devic.
 --------------------------------------------------------------*/

extern "C" DLL_EXPORT API_STATUS __stdcall CameraInitVirtual(int device_id, int pid, struct ISPParam *param);
...
/*==============================================================
Name: CameraGetStrobe
Description: Get strobe enable status.
Parameters: device_id, the camera index
            en, return status, true for enable strobe output, false for disable strobe output
Return: returns API_OK on success, otherwise returns API_ERROR.
Note:
--------------------------------------------------------------*/

extern "C" DLL_EXPORT API_STATUS __stdcall CameraGetStrobe(int device_id, bool *en);
...
/*==============================================================
Name: CameraGetTriggerPolarity
Description: Get trigger polarity.
Parameters: device_id, the camera index
            high, return the trigger polarity, true for positive pole and false for negative pole
Return: returns API_OK on success, otherwise returns API_ERROR.
Note:
--------------------------------------------------------------*/

extern "C" DLL_EXPORT API_STATUS __stdcall CameraGetTriggerPolarity(int device_id, bool *high);
...
/*==============================================================
Name: CameraGetStrobePolarity
Description: Get the strobe output polarity
Parameters: device_id, the camera index
            high, return the trigger polarity, true for positive pole and false for negative pole
Return: returns API_OK on success, otherwise returns API_ERROR.
Note:
...
extern "C" DLL_EXPORT API_STATUS __stdcall CameraGetStrobePolarity(int device_id, bool *high);


/*==============================================================
Name: CameraGetTriggerDelay
Description: Get trigger delay.
Parameters: device_id, the camera index
            *delay_us, return the delay from the trigger signal arriving.
Return: returns API_OK on success, otherwise returns API_ERROR.
Note: The precesion is 10us.
--------------------------------------------------------------*/

extern "C" DLL_EXPORT API_STATUS __stdcall CameraGetTriggerDelay(int device_id, int *delay_us);

/*==============================================================
Name: CameraSetTriggerDelay
Description: Set trigger delay.
Parameters: device_id, the camera index
            delay_us, the delay from the trigger signal arriving.
Return: returns API_OK on success, otherwise returns API_ERROR.
Note: The precesion is 10us.
--------------------------------------------------------------*/

extern "C" DLL_EXPORT API_STATUS __stdcall CameraSetTriggerDelay(int device_id, int delay_us);

/*==============================================================
Name: CameraGetStrobeDelay
Description: Get strobe delay.
Parameters: device_id, the camera index
            *delay_us, return the strobe delay from the trigger signal arriving.
Return: returns API_OK on success, otherwise returns API_ERROR.
Note: The precesion is 10us.
--------------------------------------------------------------*/

extern "C" DLL_EXPORT API_STATUS __stdcall CameraGetStrobeDelay(int device_id, int *delay_us);

/*==============================================================
Name: CameraSetStrobeDelay
Description: Set strobe delay.
Parameters: device_id, the camera index
            delay_us, the strobe delay from the trigger signal arriving.
Return: returns API_OK on success, otherwise returns API_ERROR.
Note: The precesion is 10us.
--------------------------------------------------------------*/

extern "C" DLL_EXPORT API_STATUS __stdcall CameraSetStrobeDelay(int device_id, int delay_us);

/*==============================================================
Name: CameraGetStrobeDuration
Description: Get strobe duration time in us.
Parameters: device_id, the camera index
            *duration_us, return the strobe signal's duration time in us.
Return: returns API_OK on success, otherwise returns API_ERROR.
Note: The precesion is 10us.
--------------------------------------------------------------*/

extern "C" DLL_EXPORT API_STATUS __stdcall CameraGetStrobeDuration(int device_id, int *duration_us);

/*==============================================================
Name: CameraSetStrobeDuration
Description: Set strobe duration time in us.
Parameters: device_id, the camera index
            duration_us, the strobe signal's duration time in us.
Return: returns API_OK on success, otherwise returns API_ERROR.
Note: The precesion is 10us.
--------------------------------------------------------------*/

extern "C" DLL_EXPORT API_STATUS __stdcall CameraSetStrobeDuration(int device_id, int duration_us);

/*==============================================================
Name: CameraGetDebouncerTime
Description: Get the debouncer time of the trigger signal.
Parameters: device_id, the camera index
            *debouncer_us, return the debuncer time in us
Return: returns API_OK on success, otherwise returns API_ERROR.
Note: 
--------------------------------------------------------------*/

extern "C" DLL_EXPORT API_STATUS __stdcall CameraGetDebouncerTime(int device_id, int *debouncer_us);

/*==============================================================
Name: CameraSetDebouncerTime
Description: Set the debouncer time of the trigger signal.
Parameters: device_id, the camera index
            debouncer_us, the debuncer time in us
Return: returns API_OK on success, otherwise returns API_ERROR.
Note: 
--------------------------------------------------------------*/

extern "C" DLL_EXPORT API_STATUS __stdcall CameraSetDebouncerTime(int device_id, int debouncer_us);
...
/*==============================================================
Name: CameraSetGlobalReset
Description: Set the exposure mode to global reset.
Parameters: device_id, the camera index
            en, true for enable global reset mode, false for disable.
Return: returns API_OK on success, otherwise returns API_ERROR.
Note: only part of camera support global reset feature.
--------------------------------------------------------------*/

extern "C" DLL_EXPORT API_STATUS __stdcall CameraSetGlobalReset(int device_id,bool en);

/*==============================================================
Name: CameraGetGlobalReset
Description: Get the global reset status.
Parameters: device_id, the camera index
            *en, return the state of global reset. 
Return: returns API_OK on success, otherwise returns API_ERROR.
Note: 
--------------------------------------------------------------*/

extern "C" DLL_EXPORT API_STATUS __stdcall CameraGetGlobalReset(int device_id,bool *en);
...
Note: 
--------------------------------------------------------------*/
extern "C" DLL_EXPORT API_STATUS __stdcall CameraGetLineTrigger(int device_id, int *line_trigger);
